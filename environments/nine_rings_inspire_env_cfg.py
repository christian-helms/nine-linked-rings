...
class NineLinkedRingsSceneCfg(InteractiveSceneCfg):
    """Configuration for the Nine Linked Rings scene with Inspire hand."""
    ...
    puzzle = AssetBaseCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            usd_path="/home/chris/nine-linked-rings/assets/nine-linked-rings/nine-linked-rings.usda",
        ),
        init_state=AssetBaseCfg.InitialStateCfg(
            pos=(0.3, 0.0, 0.8),  # Position in front of robot
        ),
    )
...
class NineLinkedRingsEnvCfg(ManagerBasedEnvCfg):
    """Configuration for the Nine Linked Rings environment with Inspire hand."""
    ...
    def __post_init__(self):
        ...
        # Episode length
        self.episode_length_s = 30.0  # 5 minutes for teleoperation
